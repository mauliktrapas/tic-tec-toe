...
function setOfCachedUrls(e) {
...
}var precacheConfig = [["/tic-tec-toe/index.html", "9efb555e64f8be9d1df1da0f456be81c"], ["/tic-tec-toe/static/css/main.fdd02958.css", "3c8cd2c2ff1ad8c701e5f662c25072a1"], ["/tic-tec-toe/static/js/main.33a5d2c1.js", "e97c69f7ca29f95fcac9e56d51027839"]],
  ...
  if ("GET" === e.request.method) {
    var t,
        n = stripIgnoredUrlParameters(e.request.url, ignoreUrlParametersMatching);(t = urlsToCacheKeys.has(n)) || (n = addDirectoryIndex(n, "index.html"), t = urlsToCacheKeys.has(n));!t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL("/tic-tec-toe/index.html", self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function (e) {
